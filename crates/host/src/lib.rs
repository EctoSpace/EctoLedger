...
// Re-export ecto_ledger_core's pure-logic modules into this crate's namespace.
...
pub use ecto_ledger_core::hash;
pub use ecto_ledger_core::intent;
pub use ecto_ledger_core::merkle;
